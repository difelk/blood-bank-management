...
const DonorIcon = ({ size, color }) => (
  ...
  >
    ...
    />
    <circle cx={12} cy={5} r={3} stroke={color ?? "none"} strokeWidth={2} />
    <circle cx={4} cy={9} r={2} stroke={color ?? "none"} strokeWidth={2} />
    <circle cx={20} cy={9} r={2} stroke={color ?? "none"} strokeWidth={2} />
    <path
