...
import styles from "./HospitalStockSummaryTable.module.scss";
import CustomButton from "../../customButton";
import ViewMoreIcon from "../../../../../assets/icons/svgs/ViewMore";
import CustomModal from "../../modal/CustomModal";

const HospitalStockSummaryTable = ({ tableHeader, dataset, actionType }) => {
...
export default HospitalStockSummaryTable;
